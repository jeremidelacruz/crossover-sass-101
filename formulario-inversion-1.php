		...
		<form class="row needs-validation" novalidate>
			...
			<div class="d-flex flex-wrap align-items-end w-100 mb-md-3">
				<div class="col-md-4 mb-lg-3 mb-4">
					...
					<input class="form-control txt18 has-gray-placeholder text-left" type="number" name="" placeholder="81 0000 0000" required>
				</div>
				<div class="col-md-4 mb-lg-3 mb-4">
			...
			<div class="d-flex flex-wrap align-items-end w-100 mb-3">
				<div class="col-md-4 mb-lg-3 mb-4">
					...
					<input class="form-control txt18 has-gray-placeholder text-left" type="text" name="" placeholder="Correo Electrónico" required>
				</div>
				<div class="col-md-4 mb-lg-3 mb-4">
			...
			<div class="form-group col-12 mb-md-5 mb-4 txt18">
				<div class="label-container2 position-relative">
					<input type="checkbox" name="checkmark" value="" class="d-inline"><label class="c-black d-inline" for="checkmark">Acepto los <a href="" class="has-underline">Términos y condiciones</a> y <a href="" class="has-underline">Política de privacidad</a> de SuperTasas.com</label>
